  ...
  fields: () => ({
    ...
    contributor: {
      ...
      resolve(parent, args, context) {
        ...
        return contributors.find(contributor => contributor.id === parent.contributorId);
      }
    }
  })
});
...
const ContributorType = new GraphQLObjectType({
  ...
  fields: () => ({
    ...
    articles: {
      ...
      resolve(parent, args) {
        return articles.filter(article => article.contributorId === parent.id);
      }
    }
  })
});
...
const RootQuery = new GraphQLObjectType({
  ...
  fields: {
    ...
    article: {
      ...
      resolve(parent, args, context) {
        console.log(parent, args, context.headers);
